...
export const CourseSettingsPanel = ({ course, allCourses, categories, onChange }: Props) => {
          ...
          <AccordionContent className="space-y-3 pb-3">
            ...
            <div className="grid grid-cols-2 gap-2">
              ...
              <div className="space-y-1.5">
                ...
                <Select value={course.level} onValueChange={(v) => onChange({ level: v as any })}>
                  <SelectTrigger className="rounded-xl h-9 text-xs"><SelectValue /></SelectTrigger>
                  <SelectContent>
        ...
        <AccordionItem value="pricing" className="border-b px-4">
          ...
          <AccordionContent className="space-y-3 pb-3">
            <div className="space-y-1.5">
              ...
              <Select value={course.pricingType || (course.price > 0 ? "one-time" : "free")} onValueChange={(v) => onChange({ pricingType: v as any })}>
                <SelectTrigger className="rounded-xl h-9 text-xs"><SelectValue /></SelectTrigger>
                <SelectContent>
        ...
        <AccordionItem value="access" className="border-b px-4">
          ...
          <AccordionContent className="space-y-3 pb-3">
            <div className="space-y-1.5">
              ...
              <Select value={course.accessType || "paid"} onValueChange={(v) => onChange({ accessType: v as any })}>
                <SelectTrigger className="rounded-xl h-9 text-xs"><SelectValue /></SelectTrigger>
                <SelectContent>
