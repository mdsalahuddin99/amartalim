...
export const LessonForm = ({
  ...
  const [contentType, setContentType] = useState<"video" | "text" | "live">(initial?.contentType || "video");
    ...
    <>
      ...
      <div className="space-y-4 py-4">
        ...
        <div className="space-y-2">
          ...
          <Select value={contentType} onValueChange={(v) => setContentType(v as "video" | "text" | "live")}>
