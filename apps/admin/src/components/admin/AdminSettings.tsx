...
import { Save, Globe, Bell, Shield, Palette, User, Loader2 } from "lucide-react";
...
import { saveProfileSettings, saveSiteSettings, saveNotificationSettings } from "@/server/actions/settings";
...
const AdminSettings = ({ settings }: { settings: any }) => {
  ...
  const [notifications, setNotifications] = useState({
    emailOnEnroll: settings.notifications.emailOnEnroll,
    emailOnComplete: settings.notifications.emailOnComplete,
    emailOnQuizPass: settings.notifications.emailOnQuizPass,
  ...
  return (
    <div className="space-y-4 sm:space-y-6 max-w-3xl">
      ...
      <SectionCard icon={User} title="প্রোফাইল">
        ...
        <Button onClick={handleSaveProfile} disabled={isPendingProfile} className="rounded-xl w-full sm:w-auto">
          {isPendingProfile ? <Loader2 className="mr-2 h-4 w-4 animate-spin" /> : <Save className="mr-2 h-4 w-4" />}
          {isPendingProfile ? "সংরক্ষণ হচ্ছে..." : "প্রোফাইল সংরক্ষণ"}
        </Button>
      </SectionCard>
      ...
      <SectionCard icon={Globe} title="সাইট সেটিংস">
        ...
        <Button onClick={handleSaveSite} disabled={isPendingSite} className="rounded-xl w-full sm:w-auto">
          {isPendingSite ? <Loader2 className="mr-2 h-4 w-4 animate-spin" /> : <Save className="mr-2 h-4 w-4" />}
          {isPendingSite ? "সংরক্ষণ হচ্ছে..." : "সাইট সেটিংস সংরক্ষণ"}
        </Button>
      </SectionCard>
      ...
      <SectionCard icon={Bell} title="নোটিফিকেশন">
        ...
        <Button onClick={handleSaveNotifications} disabled={isPendingNotifications} variant="outline" className="rounded-xl w-full sm:w-auto">
          {isPendingNotifications ? <Loader2 className="mr-2 h-4 w-4 animate-spin" /> : <Save className="mr-2 h-4 w-4" />}
          {isPendingNotifications ? "সংরক্ষণ হচ্ছে..." : "নোটিফিকেশন সংরক্ষণ"}
        </Button>
      </SectionCard>
