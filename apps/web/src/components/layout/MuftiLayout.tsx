...
import {
  MessageSquare, Menu, LogOut, ChevronDown, ChevronRight, LayoutDashboard
} from "lucide-react";
...
const sidebarItems = [
  { title: "ড্যাশবোর্ড", url: "/mufti", icon: LayoutDashboard },
  { title: "আমার প্রশ্ন উত্তর", url: "/mufti/qa", icon: MessageSquare },
];
  ...
  return (
    <>
      <div className="p-4">
        ...
        <div className="text-xs text-muted-foreground mt-1">মুফতি প্যানেল</div>
      </div>
      <div className="px-3 space-y-1">
        {sidebarItems.map((item) => {
          const isActive = item.url === "/mufti" 
            ? location.pathname === "/mufti" 
...
export default function MuftiLayout({ children, isMufti, isAdmin }: { children: ReactNode; isMufti?: boolean; isAdmin?: boolean }) {
